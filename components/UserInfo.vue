<template>
  <v-card elevation="0">
    <img src="~/static/Rectangle12.png" alt="Hala Ahmed" />
    <h2>Hala Ahmed</h2>
    <p>I am Hala Ahmed, I am the owner of the local brand called Beauty which is for Mackeup and Skin Care.</p>
    <div class="profile-stats">
      ...
      <div class="stats-chip">
        ...
        <div>
          <p>4.2 <span>(15)</span></p>
          <span>Rate</span>
        </div>
      </div>
    </div>
    <v-btn block class="mz-btn">Follow</v-btn>
  </v-card>
</template>
<script>
export default {
